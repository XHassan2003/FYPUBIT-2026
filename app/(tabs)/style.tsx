...
/**
 * The daily styling screen, on the "Style" tab.
 *
 * This was the app's index until virtual try-on took that slot. Nothing about
 * the screen changed with the move — only where it sits in the tab bar.
 */
